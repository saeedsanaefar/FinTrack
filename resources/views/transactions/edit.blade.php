                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('transactions.update', $transaction) }}" id="transactionForm">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="date" class="block mt-1 w-full" type="date" name="date" :value="old('date', $transaction->date ? $transaction->date->format('Y-m-d') : '')" max="{{ date('Y-m-d') }}" required />
